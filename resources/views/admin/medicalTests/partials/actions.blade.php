...
@if (auth('admin')->user()->can('view_city') || auth('admin')->user()->can('edit_city')||auth('admin')->user()->can('delete_city'))
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
        ...
        @if (auth('admin')->user()->can('edit_city'))
            <div class="menu-item px-3">
                <a class="menu-link px-3 edit" data-city_id="{{ $data->id }}"
        ...
        @endif
        @if (auth('admin')->user()->can('delete_city'))
            <div class="menu-item px-3">
