...
@section('title', __('label.cities'))
@section('toolbarSubTitle', __('label.cities'))
@section('toolbarPage', __('label.dispaly_all_cities'))
...
@section('content')
    ...
    @include('admin.cities.Model.create_update')
@endsection

@push('scripts')
    @include('admin.cities.js.js')
@endpush
