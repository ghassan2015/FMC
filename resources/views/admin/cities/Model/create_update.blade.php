<div class="modal fade" id="kt_modal_add_edit" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <!-- Modal Body -->
            <form id="my-form" action="{{ route('admin.settings.cities.store') }}" method="post"
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" class="form-control form-control-solid" id="add_edit_city_id"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 ">
                            <div class="form-check form-check-custom form-check-solid">
                                <input class="form-check-input" checked type="checkbox" id="is_active" value="1"
                                    name="is_active">
                                <label class="form-check-label ms-2"
                                    for="is-active">{{ __('label.status') }}</label>
                            </div>
                        </div>
                    </div>
