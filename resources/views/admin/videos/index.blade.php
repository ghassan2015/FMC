...
@section('toolbarSubTitle', __('label.videos_list'))
@section('toolbarPage', __('label.display_all_videos'))
...
@section('content')
    ...
    <table id="kt_datatable_example_1" class="table align-middle table-row-dashed fs-6 gy-5 data-table">
        <thead>
            <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                ...
                @if (auth('admin')->user()->can('update_status_video'))
    ...
    @include('admin.videos.Modal.add_edit')
@endsection

@push('scripts')
    @include('admin.videos.js.index')
@endpush
