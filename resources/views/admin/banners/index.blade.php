...
@section('title', __('label.banners'))
@section('toolbarSubTitle', __('label.banner_list'))
@section('toolbarPage', __('label.display_all_banners'))
...
@section('content')
    <div class="d-flex flex-column flex-md-row flex-stack mb-5 gap-3">
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-end gap-2" data-kt-docs-table-toolbar="base">
            ...
            @can('add_banner')
            <button type="button" class="btn btn-primary add_banner" data-bs-toggle="tooltip"
                title="{{ __('label.add_new_banner') }}">
                <i class="ki-duotone ki-plus fs-2"></i>
                {{ __('label.add_new_banner') }}
            </button>
            @endcan
        </div>
        <!-- Group actions -->
    ...
    @include('admin.banners.Modal.add_edit')
@endsection

@push('scripts')
    @include('admin.banners.js.index')
@endpush
