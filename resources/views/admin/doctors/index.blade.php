...
@section('title', __('label.doctors'))
...
@section('content')
    ...
    <div id="filter-section" class="row mb-5 d-none align-items-end">
        ...
        <div class="col-12 col-md-4 mb-3 mb-md-0">
            <select class="form-select form-select-solid" dir="rtl" data-control="select2" id="specializationFilter">
                <option value="">{{ __('label.specializations') }}</option>
...
@push('scripts')
    @include('admin.doctors.js.index')
@endpush
