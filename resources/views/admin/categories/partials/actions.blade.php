                        @if(auth('admin')->user()->can('edit_category')||auth('admin')->user()->can('delete_category'))
                ...
                @can('edit_category')
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                        ...
                        <div class="menu-item px-3">
                            <a href="{{ route('admin.categories.edit', $data->id) }}" class="menu-link px-3"
                    ...
                    @can('delete_category')
                        <div class="menu-item px-3">
                            <a data-id="{{ $data->id }}" class="menu-link px-3 delete "
                                ...
                                " class="delete" title="{{ __('label.delete') }}">
