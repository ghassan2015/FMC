@if (auth('admin')->user()->can('edit_specialization') || auth('admin')->user()->can('delete_specialization'))
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
        data-kt-menu="true">
        @if (auth('admin')->user()->can('edit_specialization'))
            <div class="menu-item px-3">
                <a class="menu-link px-3 edit"
                data-specialization_id="{{ $data->id }}"
        ...
        @endif
        @if (auth('admin')->user()->can('delete_specialization'))
            <div class="menu-item px-3">
