    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel">{{ __('label.branch_data') }}</h6>
            ...
            <form class="needs-validation" id="my-form" novalidate method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6">
                            <label class="form-label required" for="address_ar">{{ __('label.address') }} (AR) </label>
                            <textarea  name="address_ar" class="form-control" id="address_ar" required></textarea>
                            <div class="address_ar error"></div>
                        </div>

                             <div class="col-md-6">
                            <label class="form-label required" for="address_en">{{ __('label.address') }} (EN) </label>
                            <textarea  name="address_en" class="form-control" id="address_en" required></textarea>
                            <div class="address_en error"></div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-12">
                            ...
                            <label class="form-switch">
                                <input class="form-check-input" name="is_active" id="is_active" type="checkbox" checked>
