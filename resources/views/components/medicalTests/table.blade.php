...
<div class="d-flex flex-column flex-md-row flex-stack mb-5 gap-3">
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-end gap-2" data-kt-docs-table-toolbar="base">
        <button type="button" class="btn btn-light-primary me-0 me-sm-3" onclick="toggleMedicalTestFilter()">
        ...
        <a class="btn btn-primary add_medical_test" data-bs-toggle="tooltip"
...
<table id="medical_test_table" class="table align-middle table-row-dashed fs-6 gy-5">
    <thead>
        <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
            <th></th>
            <th>{{ __('label.name') }}</th>
            <th>{{ __('label.medical_test_type') }}</th>
