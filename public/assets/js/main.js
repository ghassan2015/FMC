...
==================================*/
  ...
  /*---------- 01. On Load Function ----------*/
    ...
    $(".vs-hero-carousel").each(function () {
        ...
        vsHslide
                    ...
                    vsHslide.find(".ls-custom-arrow").each(function () {
                        $(this).on("click", function (e) {
                            ...
                            $(this)
                                ...
                                .layerSlider(gotarget);
                        });
                    });

                    // Add class To current Thumb
                    var currentNav =
                        customNav + "[" + navDom + '="' + currentSlide + '"';
            ...
            .on("slideChangeDidComplete", function (event, slider) {
                ...
                var currentNav =
                    '.ls-custom-dot[data-slide-go="' + currentActive + '"';
                $(currentNav)
                    .addClass("active")
                    .siblings()
                    .removeClass("active");
        ...
        vsHslide.layerSlider({
            ...
            thumbnailNavigation:
                d("thumbnailnavigation") === false ? false : true,
    ...
    $(".banner-slider-v7")
        ...
        .slickAnimation();
    var isRTL = $("html").attr("dir") === "rtl"; // true إذا الصفحة عربية، false إذا إنجليزية
